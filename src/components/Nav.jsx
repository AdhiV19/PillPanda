  ...
  return (
    <header className="sticky top-0 z-40 ">
      <nav className="   bg-pandaWhite dark:bg-pandaBlack  px-6 py-4 flex items-center justify-between text-pandaBlack dark:text-pandaWhite shadow dark:shadow-grey">
        <div className="text-4xl font-bold ms-10  "><a href="#">PillPanda</a></div>
        ...
        <div className="flex items-center space-x-6 mx-8">
          ...
          <button className="px-4 py-1.5 border-pandaGreen border-2  rounded-md hover:bg-green-200 text-sm">
            Log In
          </button>
          <button className="px-4 py-2 bg-pandaGreen text-pandaWhite rounded-md hover:opacity-70 text-sm dark:bg-pandaGreen dark:text-pandaBlack">
            Sign Up
          </button>
          ...
          <label className="relative inline-flex items-center cursor-pointer">
            ...
            <img src={darkMode ? "/moon.png" : "/sun.png"} className={darkMode ? " left-3 h-5 w-5" : "ms-1 h-4 w-4"}/>
